              ...
              <div key={item.id} className="w-full">
                <div className="flex h-80 w-2/3 m-auto p-10 rounded-md bg-zinc-200 gap-10">
                  ...
                  <img
                    src={item.image}
                    alt={item.name}
                    className="w-1/2 h-full object-cover rounded-lg relative before:content-['Image_not_found'] before:absolute before:w-full before:h-full before:bg-zinc-300 before:top-0 before:left-0 before:grid before:place-items-center before:text-zinc-600 before:text-sm"
                    loading="lazy"
                  />
                </div>
              </div>
